...
export const ROLE_PERMISSIONS: Record<Role, PermissionKey[]> = {
  ...
  [Role.independent_carrier]: [P.DRIVER_JOBS_READ, P.SHIPMENT_TRACK],
  [Role.employee_driver]: [P.DRIVER_JOBS_READ, P.INSPECTION_SUBMIT, P.POD_SUBMIT, P.SHIPMENT_TRACK],
  [Role.lease_operator]: [P.DRIVER_JOBS_READ, P.INSPECTION_SUBMIT, P.POD_SUBMIT, P.SHIPMENT_TRACK],
  [Role.dispatcher]: [
    P.SHIPMENT_READ_ALL,
